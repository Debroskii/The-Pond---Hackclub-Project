...
class Fish:
    def __init__(self, color_config, scale: float):
        ...
        self.scale = scale
        self.kine_chain = UIKinematicsChain([20, 20, 20, 20, 5, 0])
        self.kine_sizes = [2, 5, 10, 12, 12, 10]
        self.tail = Tail(35, scale)
        self.curve = 0
    ...
    def draw(self, surface):        
        ...
        draw.rotated_ellipse(surface, self.color_config.accent_color, (forefin_position_1.x, forefin_position_1.y, 28, 13), -forefin_joint.angle - fin_angle)
        draw.rotated_ellipse(surface, self.color_config.accent_color, (forefin_position_2.x, forefin_position_2.y, 28, 13), -forefin_joint.angle + fin_angle)
        
        draw.rotated_ellipse(surface, self.color_config.accent_color, (postfin_position_1.x, postfin_position_1.y, 22, 9), -postfin_joint.angle - fin_angle)
        draw.rotated_ellipse(surface, self.color_config.accent_color, (postfin_position_2.x, postfin_position_2.y, 22, 9), -postfin_joint.angle + fin_angle)
